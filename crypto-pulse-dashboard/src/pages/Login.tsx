  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary/10 via-background to-primary/5 p-8">
        <div className="max-w-md text-center space-y-6 animate-float">
          <div className="relative mx-auto w-64 h-64">
            <div className="absolute inset-0 rounded-full bg-primary/20 blur-3xl" />
            <div className="relative h-full w-full rounded-full bg-gradient-to-br from-primary/30 to-primary/10 flex items-center justify-center">
              <Activity className="h-24 w-24 text-primary" />
            </div>
          </div>
          <h2 className="text-2xl font-bold">Track Your Portfolio</h2>
          <p className="text-muted-foreground">
            Real-time cryptocurrency tracking with advanced analytics and personalized alerts.
          </p>
        </div>
      </div>
    </div>
